...
struct FolderGalleryView: View {
    ...
    private var collectionView: some View {
        NativeFolderCollectionView(
            ...
            existingEvaluations: cachedEvaluations,
    ...
    private func updateFilteredImages() {
        ...
        // Update the cached evaluations dictionary for the collection view
        cachedEvaluations = evaluationCache.compactMapValues { $0 }
